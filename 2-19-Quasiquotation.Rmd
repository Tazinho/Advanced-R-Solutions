...
1. __[Q]{.Q}__: Given the following components:
   ...
   __[A]{.solved}__: Given the quoted expressions from the first chunk as building blocks, we can construct the desired calls by combining and unquoting these expressions.

...
3. __<span style="color:red">Q</span>__: What happens if you try and use `enexpr()` with an expression (i.e. `enexpr(x + y)`)? What happens if `enexpr()` is passed a missing argument?

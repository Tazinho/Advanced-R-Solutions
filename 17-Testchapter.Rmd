...
1.  __<span style="color:red">Q</span>__: How are `r exprs(a)` and `r exprs(a = )` different? Think about both the input and the output.
...
<!-- QUESTION: Why does `expr(a =)` not work? -->

...
1.  __<span style="color:red">Q</span>__: Two arithmetic operators can be used in both prefix and infix style.
    ...
    __<span style="color:orange">A</span>__: I am not sure how this is ment to be. Theoretically every arithmetic operator can be written in prefix notation via backticks. On the other hand, `+` and `-` seem to be the only ones, which can be written in infix notation without backticks.

...
1.  __<span style="color:red">Q</span>__: What's the difference between the generics generated by these two calls?
    ...
    __<span style="color:orange">A</span>__: The first call defines a standard generic and the second one creates a nonstandard generic. One can confirm this directly whlie printing (showing in S4 slang) the function.

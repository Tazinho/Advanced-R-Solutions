...
<!-- TODO: Possibly add a hyperlink to the programming with dplyr-vignette or so. -->

<!-- QUESTION: is `mean(mpg)` really quoted and not evaluated? -->
<!-- thinking of mean = mean(!! mpg_quo) style, which doesn't unquote the function itsself. -->

...
HB: I think, this is correct. I mean, there are not that many arithmetic operators, so what can we be missing. I would use these example from `r ?Arithmetic`
...
in the answer and put it to green then.

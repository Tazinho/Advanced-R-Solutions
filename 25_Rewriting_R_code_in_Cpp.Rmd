...
<!-- HW: I think just showing how you'd rewrite one function is probably adequate here. If you wanted to do more, I'd suggest a variation where you put the `na_rm` check inside the inner loop. You can discuss that's a bit slower but there's less duplicated code -->
...
<!-- HW: I think this was an error; it feels rather different to the other questions -->

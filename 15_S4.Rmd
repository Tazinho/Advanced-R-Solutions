...
__[A]{.solved}__: We keep things simple and will just return `"180cm"`, whe the `length()` method is called on a `Person` object. The method can be defined either as an S3 or S4 method.

...
1. __<span style="color:red">Q</span>__: Rewrite the following code snippets into prefix form:
   ...
   __<span style="color:green">A</span>__: In the following, we rewrite the expressions to match the exact syntax from above. Since prefix functions have the same operator precedence as brackets, we can omit the brackets in the second expression and provide the regarding alternative version as a comment.

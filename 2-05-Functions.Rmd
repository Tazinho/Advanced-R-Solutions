...
2. __<span style="color:red">Q</span>__: Clarify the following list of odd function calls:
   ...
   __<span style="color:green">A</span>__: Since none of these functions provides a `...` argument, we only need to consider, that function arguments are first machted by exactly, then via partial matching and finally by position. This leads us to:

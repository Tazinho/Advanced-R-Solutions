...
3.  __<span style="color:red">Q</span>__: R has two classes for representing date time data, `POSIXct` and 
    ...
    Compare method behaviors between the two classes:
   
    ```{r}
    
    #get method information for the two classes
    ct_ms<-attr(methods(class='POSIXct'),'info')
    ...
    #compare functions (with the same function names) between POSIXct and POSIXlt

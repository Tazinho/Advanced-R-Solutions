...
- This book is intended as supplement to Advanced R

- We have worked through the book and the exercises ourselves and the first solutions were the by-product of this process.
- As the idea of the book matured we strived to solve the exercise in a clean, straightforward, readable and exemplary manner.
...
- we tried to provide solutions in a clear, concise and consistent way.
- We tried to use prose to motivate the approaches taken and add useful information where appropriate, but a lot of the solutions consist of mostly code. We tried to write the solutions as clear and expressive as possible.
...
- When we started to read Advanced R, we found that it introduces R as a programming language in a clear and structured way.
  - also the deeper subject are presented in a accessible way
...
- Reading about programming is nice. But opening the editor and implementing what you've learned is even more beneficial. Becoming familiar with the more abstract ideas, requires practice.
...
benefit.
- Many exercises will help you deepen your understanding of the presented
- You can use our solutions to review your solutions, consider alternative implementations and avoid getting stuck, as some topics or exercises may be quite different than what you typically encounter. :)
...
- the other chapters mostly helped me build confidence after working through them.... :)
...
- the solutions are written from our perspective (intermediate R programmers), so here is a little bit about our background
  ...
  - Our eductional background: Math and statistics background, not necessarily so much programming experience
...
- only a few of the more difficult exercises in the book were solved in one session. It was mostly a mix of re-reading the question, checking up on the related "Advanced R" section and starting to write some first code and consulting the documentation.
...
- We don't necessarily need most of the skills taught in Advanced R in our day to day work
- but the code we write has become more robust, concise and readable (we hope!) (It's quite easy to see the difference, when we look into the early drafts of this book!)
- refer to iceberg skill model, builds a good foundation

- [Tidyverse Style Guide](https://style.tidyverse.org/) is so helpful
    in day to day coding. Because it establishes meaningful conventions,
    your code becomes more standardized (which makes it easier to spot
    errors) and the process of formatting it becomes also more
    streamlined (fewer decisions, automated formatting tools such as
    `{styler}`).
...
- we may not really be in a position to provide additional book recommendations to guide your learning (we have to leave this to other people)
    - we enjoyed the language-agnostic approach presented in "The pragmatic programmer"
...
- copy from index.hmtl

## Conventions

- reference to Adv R as „textbook"
- explain chapter enumeration
- conventions for style of names for objects, functions, classes,
    packages.

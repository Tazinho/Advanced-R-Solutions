...
1. __<span style="color:red">Q</span>__: Which two of the six types of atomic vector can't appear in an expression? 
   ...
   __<span style="color:green">A</span>__: It is not possible to create an expression that evaluates to an atomic of length greater than one without using a function (e.g. the `c()` funtion). But expressions that include a function are calls.

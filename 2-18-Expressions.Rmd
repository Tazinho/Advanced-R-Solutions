...
4. __<span style="color:red">Q</span>__: What does `!1 + !1` return? Why?
   ...
   So, the right `!1` becomes evaluated, which results in `FALSE`, because in R every non 0 numeric, becomes coerced to `TRUE`, when a logical operator is applied on it.
   ...
   However, note that if `!` had a higher precedence, the result would get `FALSE + FALSE` as intermediate result, which would be evalutated (involving coercion again) to `0`.

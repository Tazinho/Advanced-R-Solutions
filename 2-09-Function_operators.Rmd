...
3.  __<span style="color:red">Q</span>__: Create a FO that reports whenever a file is created or deleted in the working directory, using `dir()` and `setdiff()`. What other global function effects might you want to track?
   
   __<span style="color:green">A</span>__:
   
4.  __<span style="color:red">Q</span>__: Write a FO that logs a timestamp and message to a file every time a function is run.

...
df_new <- tibble::tribble(~ `1 Names and values`, ~ `2 Vectors`, ~ `3 Subsetting`, ~ `4 Control Flow`, ~ `5 Functions`, ~ `6 Environments`, ~ `7 Conditions`, ~ `8 Functionals`, ~ `9 Function factories`,  ~ `10 Function operators`,  ~ `11 S3`, ~`12 S4`, ~`13 R6`, ~`14 Expressions`, ~`15 Quasiquotation`, ~`16 Evaluation`, ~`17 Translating R code`, ~ `18 Performance`, ~ `19 Optimising code`, ~ `20 High performance functions with Rcpp`,
                       ...
                       "x",  "x",  "x",   "NA",   "x",  "o",  "x",  "x",  "x",   NA,   "x",    "x",   NA,  "x",     "x",   "-",  "-",  "-",  "x",  "-",
                       "x",  "x",  "x",   "NA",   "x",  "x",  "x",  "x",  "-",   NA,   "x",    "x",   NA,  "x",     "-",   "x",   NA,  "-",  "x",  "x",
                       "x",  "x",  "x",   "NA",   "x",  "-",  "x",  "x",  "x",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,  "-",  "x",  "x",
                       "x",  "x",  "x",   "NA",   "x",  "o",  "o",  "x",  "-",   NA,   "-",     NA,   NA,  "-",     "x",   "-",   NA,  "-",  "x",  "x",
                       "x",  "x",  "x",   "NA",   "x",  "x",  "o",  "x",  "-",   NA,   "-",     NA,   NA,  "x",     "-",   "-",   NA,  "-",  "-",  "-",
                       "x",  "x",  "x",   "NA",   "x",  "-",  "-",  "x",  "-",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,  "-",  "x",   NA,
                       "x",  "x",   NA,   "NA",   "x",  "x",  "-",  "x",  "-",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       "o",  "x",   NA,   "NA",   "x",   NA,  "x",  "x",  "-",   NA,   "-",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "-",   NA,
                       "x",  "x",   NA,   "NA",   "x",   NA,   NA,  "x",   NA,   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       "x",  "x",   NA,   "NA",   "x",   NA,   NA,  "x",   NA,   NA,   "-",     NA,   NA,  "x",     "-",   "-",   NA,   NA,  "x",   NA,
                        NA,  "x",   NA,   "NA",   "x",   NA,   NA,  "x",   NA,   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                        NA,  "x",   NA,   "NA",   "x",   NA,   NA,  "x",   NA,   NA,   "o",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                        NA,  "x",   NA,   "NA",   "x",   NA,   NA,  "x",   NA,   NA,   "o",     NA,   NA,  "x",     "-",   "-",   NA,   NA,   NA,   NA,
                        NA,  "x",   NA,   "NA",   "x",   NA,   NA,  "-",   NA,   NA,   "-",     NA,   NA,  "x",     "x",   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "-",      NA,   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,   "o",     NA,   NA,  "-",      NA,   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,   "-",     NA,   NA,  "x",      NA,   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "x",      NA,   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "x",      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,  "x",      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "NA",   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,

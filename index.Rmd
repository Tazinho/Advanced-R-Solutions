...
df_new <- tibble::tribble(~ `1 Introduction`, ~ `2 Names and values`, ~ `3 Vectors`, ~ `4 Subsetting`, ~ `5 Control flow`, ~ `6 Functions`, ~ `7 Environments`, ~ `8 Conditions`, ~ `9 Functionals`, ~ `10 Function factories`,  ~ `11 Function operators`, ~ `12 Base types`, ~ `13 S3`, ~`14 R6`, ~`15 S4`, ~`16 Expressions`, ~`17 Quasiquotation`, ~`18 Evaluation`, ~`19 Translating R code`, ~ `20 Performance`, ~ `21 Optimising code`, ~ `22 High performance functions with Rcpp`,

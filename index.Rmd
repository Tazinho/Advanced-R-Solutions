...
This book offers solutions to the exercises from Hadley Wickham's book [Advanced R](https://adv-r.hadley.nz/) (Edition 2). It is work in progress and under active development. The 2nd edition of Advanced R is in print now and we hope to provide most of the answers in 2020.
...
contributors <- paste0("`@",
                       sort(
                         unique(read.csv("contributors.csv")$username)
                         ),
                       "`")
...
# plot_progress %>%
# plotly::ggplotly(tooltip = c("subchapter",
#                              "exercise",
#                              "credits")) %>% 

...
This is the website for **"Advanced R Solutions"** which provides solutions to the exercises from Hadley Wickham's [Advanced R](https://adv-r.hadley.nz/), Second Edition. A print version of this book will soon be released as part of Chapman & Hall’s R Series. All the solutions have been carefully documented, and made to be as clear and accessible as possible. Working through the exercises and their solutions will give you a deeper understanding of a variety of programming challenges, many of which are relevant to everyday work.

...
df_new <- tibble::tribble(~ `1 Introduction`, ~ `2 Names and values`, ~ `3 Vectors`, ~ `4 Subsetting`, ~ `5 Control flow`, ~ `6 Functions`, ~ `7 Environments`, ~ `8 Conditions`, ~ `9 Functionals`, ~ `10 Function factories`,  ~ `11 Function operators`,  ~ `12 S3`, ~`13 S4`, ~`14 R6`, ~`15 Expressions`, ~`16 Quasiquotation`, ~`17 Evaluation`, ~`18 Translating R code`, ~ `19 Performance`, ~ `20 Optimising code`, ~ `21 High performance functions with Rcpp`,
                       NA, "x",  "x",  "x",   "-",   "x",  "x",  "x",  "-",  "x",  "-",   "o",    "x",  "-",  "x",     "x",   "x",  "x",  "-",  "-",  "x",
                       NA, "x",  "x",  "x",   "-",   "x",  "x",  "x",  "x",  "o",  "-",   "-",    "o",  "-",  "x",     "x",   "o",  "o",  "x",  "-",  "x",
                       NA, "x",  "x",  "x",   "-",   "x",  "x",  "x",  "x",  "x",  "-",   "x",    "x",   NA,  "x",     "x",   "x",  "x",  "x",  "x",  "x",
                       NA, "x",  "x",  "x",   "-",   "x",  "x",  "x",  "x",  "x",  "-",   "x",    "x",   NA,  "x",     "x",   "-",  "x",  "-",  "x",  "x",
                       NA, "x",  "x",  "x",   "-",   "x",  "-",  "-",  "x",  "x",  "-",   "x",    "x",   NA,  "x",     "x",   "-",  "-",  "x",  "o",  "x",
                       NA, "x",  "x",  "x",    NA,   "x",  "o",  "x",  "x",  "x",   NA,   "x",    "x",   NA,  "x",     "x",   "-",  "-",  "-",  "x",  "-",
                       NA, "x",  "x",  "x",    NA,   "x",  "x",  "x",  "x",  "-",   NA,   "x",    "x",   NA,  "x",     "-",   "x",   NA,  "-",  "x",  "x",
                       NA, "x",  "x",  "x",    NA,   "x",  "-",  "x",  "x",  "x",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,  "-",  "x",  "x",
                       NA, "x",  "x",  "x",    NA,   "x",  "o",  "o",  "x",  "-",   NA,   "-",     NA,   NA,  "-",     "x",   "-",   NA,  "-",  "x",  "x",
                       NA, "x",  "x",  "x",    NA,   "x",  "x",  "o",  "x",  "-",   NA,   "-",     NA,   NA,  "x",     "-",   "-",   NA,  "-",  "-",  "-",
                       NA, "x",  "x",  "x",    NA,   "x",  "-",  "-",  "x",  "-",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,  "-",  "x",   NA,
                       NA, "x",  "x",   NA,    NA,   "x",  "x",  "-",  "x",  "-",   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       NA, "o",  "x",   NA,    NA,   "x",   NA,  "x",  "x",  "-",   NA,   "-",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "-",   NA,
                       NA, "x",  "x",   NA,    NA,   "x",   NA,   NA,  "x",   NA,   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       NA, "x",  "x",   NA,    NA,   "x",   NA,   NA,  "x",   NA,   NA,   "-",     NA,   NA,  "x",     "-",   "-",   NA,   NA,  "x",   NA,
                       NA,  NA,  "x",   NA,    NA,   "x",   NA,   NA,  "x",   NA,   NA,   "x",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       NA,  NA,  "x",   NA,    NA,   "x",   NA,   NA,  "x",   NA,   NA,   "o",     NA,   NA,  "x",     "x",   "-",   NA,   NA,  "x",   NA,
                       NA,  NA,  "x",   NA,    NA,   "x",   NA,   NA,  "x",   NA,   NA,   "o",     NA,   NA,  "x",     "-",   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,  "x",   NA,    NA,   "x",   NA,   NA,  "-",   NA,   NA,   "-",     NA,   NA,  "x",     "x",   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "-",      NA,   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,   "o",     NA,   NA,  "-",      NA,   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,   "-",     NA,   NA,  "x",      NA,   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "x",      NA,   "-",   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,   "x",     NA,   NA,  "x",      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,  "x",      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,
                       NA,  NA,   NA,   NA,    NA,   "x",   NA,   NA,   NA,   NA,   NA,    NA,     NA,   NA,   NA,      NA,    NA,   NA,   NA,   NA,   NA,

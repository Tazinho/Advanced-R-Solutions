...
df_new <- tibble::tribble(~ `1 Names and values`, ~ `2 Vectors`, ~ `3 Subsetting`, ~ `4 Functions`, ~ `5 Environments`, ~ `6 Conditions`, ~ `7 Functionals`, ~ `8 Function factories`,  ~ `9 Function operators`,  ~ `10 S3`, ~`11 S4`, ~`12 R6`, ~`13 Expressions`, ~`14 Quasiquotation`, ~`15 Evaluation`, ~`16 Translating R code`, ~ `17 Performance`, ~ `18 Optimising code`, ~ `19 High performance functions with Rcpp`,
                       ...
                       "x",  "x",  "x",   "x",  "-",  "x",  "x",  "x",  "x",   "x",    "-",  "-",   "x",     "x",   "x",  "-",  "x",  "-",  "x",
                       "x",  "x",  "x",   "x",  "-",  "x",  "x",  "x",  "x",   "-",    "x",   NA,   "x",     "x",   "-",  "-",  "x",  "x",  "x",
                       "x",  "x",  "x",   "x",  "-",  "x",  "x",  "x",  "x",   "x",    "x",   NA,   "x",     "x",   "-",  "-",  "-",  "x",  "x",
                       "x",  "x",  "x",   "x",  "-",  "x",  "x",  "x",  "x",   "x",    "x",   NA,   "x",     "x",   "-",  "-",  "x",  "x",  "x",
                       "x",  "x",  "x",   "x",  "x",  "x",  "x",  "x",  "-",   "x",    "-",   NA,   "x",     "x",   "-",  "-",  "-",  "x",  "-",
                       "x",  "x",  "x",   "x",  "x",  "x",  "x",  "-",  "x",   "x",    "x",   NA,   "x",     "-",   "x",   NA,  "-",  "x",  "x",
                       "x",  "x",  "x",   "x",  "-",  "x",  "x",  "-",  "x",   "x",     NA,   NA,   "x",     "x",   "-",   NA,  "-",  "x",  "x",
                       "-",  "x",  "x",   "x",  "x",  "-",  "x",   NA,  "x",   "x",     NA,   NA,   "-",     "x",   "-",   NA,  "-",  "x",  "x",
                       "-",  "x",  "x",   "x",  "x",  "-",  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "-",   "-",   NA,  "-",  "-",  "-",
                       "x",  "x",  "x",   "x",  "-",  "-",  "x",   NA,  "-",   "-",     NA,   NA,   "x",     "x",   "-",   NA,  "-",  "x",   NA,
                       "x",  "x",   NA,   "x",  "x",  "-",  "-",   NA,  "x",   "x",     NA,   NA,   "x",     "-",   "-",   NA,   NA,  "x",   NA,
                       "-",  "x",   NA,   "x",   NA,  "-",  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "x",   "-",   NA,   NA,  "-",   NA,
                        NA,  "x",   NA,   "x",   NA,  "-",  "x",   NA,  "-",   "x",     NA,   NA,   "x",     "x",   "-",   NA,   NA,  "x",   NA,
                        NA,  "x",   NA,   "x",   NA,   NA,  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "x",   "-",   NA,   NA,  "x",   NA,
                        NA,  "x",   NA,   "x",   NA,   NA,  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "-",   "-",   NA,   NA,  "x",   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,  "-",   "x",     NA,   NA,   "x",     "x",   "-",   NA,   NA,  "x",   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "x",   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,  "x",   "x",     NA,   NA,   "x",     "-",   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   "x",     "x",   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   "x",      NA,   "-",   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   "x",      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "-",   NA,   NA,    NA,     NA,   NA,   "x",      NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "-",   NA,   NA,    NA,     NA,   NA,   NA,       NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "-",   NA,   NA,    NA,     NA,   NA,   NA,       NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   NA,       NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "x",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   NA,       NA,    NA,   NA,   NA,   NA,   NA,
                        NA,   NA,   NA,   "-",   NA,   NA,  "x",   NA,   NA,    NA,     NA,   NA,   NA,       NA,    NA,   NA,   NA,   NA,   NA,

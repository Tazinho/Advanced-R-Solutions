...
2. __<span style="color:red">Q</span>__: Read the source code for `possibly()`. How does it work?
   ...
   __<span style="color:green">A</span>__: `possibly()` is a function operator that modifies functions to return a specified default value in case of an error (`otherwise`) and to suppress any error messages (`quiet = TRUE`).

...
For most of this chapter base R [@RLanguage] is sufficient. Just a few exercises require the `{rlang}`, `{dplyr}`, `{purrr}` and `{ggplot2}` packages [@rlang; @dplyr; @purrr; @ggplot2].

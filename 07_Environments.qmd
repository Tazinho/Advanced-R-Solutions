...
__[A]{.solved}__: We follow a similar approach to the previous exercise. This time we additionally check if the found object is a function and implement an argument to turn off the recursion, if desired.
...
knitr::include_graphics(
  "images/environments/function_environments_corrected.png",
  dpi = 300
)
```

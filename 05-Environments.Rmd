...
2.  __<span style="color:red">Q</span>__: Draw a diagram that shows the enclosing environments of this function:
    ...
    __<span style="color:green">A</span>__: (style and spelling will be corrected):
    
    ```{r, echo = FALSE}
    knitr::include_graphics("diagrams/enclosing_environments_sc.png", dpi = 96)
    ```
...
__<span style="color:green">A</span>__: (style and spelling will be corrected):
    ...
    ```{r, echo = FALSE}
    knitr::include_graphics("diagrams/enclosing_and_binding_environments_sc.png", dpi = 96)
    ```
...
__<span style="color:green">A</span>__: (style and spelling will be corrected):
    ...
    ```{r, echo = FALSE}
    knitr::include_graphics("diagrams/enclosing_binding_calling_execution_environments_sc.png", dpi = 96)
    ```

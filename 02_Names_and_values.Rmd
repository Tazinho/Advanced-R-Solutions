...
3. __[Q]{.Q}__: Predict the output of the following code:
  ...
  vector has 48 bytes of overhead:
   ...
   When we modify the first element of `b[[1]]` copy-on-modify occurs. Both elements will still have the same size (8,000,040 bytes) but a the first one gets a new address in memory. As `b`'s elements don't share references anymore, its object size adds up to the sum of the elements and the length-2 list: 8,000,048 B + 8,000,048 B + 64 B = 16,000,160 B (16 MB).

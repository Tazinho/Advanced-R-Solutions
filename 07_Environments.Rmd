...
__[A]{.solved}__: `where()` searches (recursively) for a given name within a given environment and its ancestors. If `where()` finds the name in one of these environments, it reutrns the environment's name. Otherwise, it throws an error.

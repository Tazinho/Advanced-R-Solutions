...
<!-- !Hier noch den Hintergrund erklären, warum es passiert. (Faktor ist eigentlich integer und die Zuordnung zu den levels ändert die ausgegebenen Werte. Der eigentliche integer-Teil des Faktors bleibt unverändert.) -->
...
__<span style="color:green">A</span>__: Yes, you can create them easily. Also both dimensions can be 0:
    ...
    head(iris)[-(1:6), -(1:5)] # or just data.frame()
    ```

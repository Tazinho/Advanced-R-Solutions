...
__<span style="color:green">A</span>__: It is a practical concern. When you combine `NA`'s in `c()` with other atomic types they will be coerced
...
2.  __<span style="color:red">Q</span>__: What happens to a factor when you modify its levels? 
    ...
    __<span style="color:green">A</span>__: Both, the entries of the factor and also its levels get reversed:

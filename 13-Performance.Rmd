...
1.  __<span style="color:red">Q</span>__: `scan()` has the most arguments (21) of any base function. About how
    ...
    __<span style="color:green">A</span>__: According to the textbook every extra argument slows the function down by apprximately 20 nanoseconds, which I can't reproduce on my system:

...
3. __<span style="color:red">Q</span>__: Predict the output of the following code:
   ...
   __<span style="color:orange">A</span>__: TODO: lobstr and pryr return very different results (600 byites vs 4MB in the first example) before we rewrite this answer it needs to be cleared, why these differences occur.

...
1. __<span style="color:red">Q</span>__: Which of the following commands is equivalent to `with(x, f(z))`?
   ...
   __<span style="color:green">A</span>__: (e) "It depends" is the correct answer. Usually `with()` is used with a data frame, so you'd usually expect (b), but if it's a list, it could be any of the options.

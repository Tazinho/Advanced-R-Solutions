...
# perform the same with POSIXlt (there should be NAs introduced by coercion)
...
2. __<span style="color:red">Q</span>__: What happens if you attempt to set rownames that are not unique?
    ...
    __<span style="color:orange">A</span>__
    An error is thrown. Besides that I need to inspect the following functions for further details...

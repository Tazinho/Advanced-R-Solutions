...
5. __<span style="color:red">Q</span>__: Precisely what do is.atomic(), is.numeric(), and is.vector() test for?
   ...
   __is.vector__: Tests if and object has no attributes, except for names and if its `mode()` is atomic (`"logical"`, `"integer"`, `"double"`, `"complex"`, `"character"`, `"raw"`), `"list"` or `"expression"`.

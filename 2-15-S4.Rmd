...
1. __<span style="color:red">Q</span>__: Extend the Person class with fields to match `utils::person()`. Think about what slots you will need, what class each slot should have, and what you’ll need to check in your validity method.
   ...
   __<span style="color:yellow">A</span>__: From `?utils::person` we can find out that the following slots are needed `given`, `family`, `role`, `email`, `comment`. All these slots must be of type character. The entries in the `role` slot must match one of the following abbreviations "aut", "com", "cph", "cre", "ctb", "ctr", "dtc", "fnd", "rev", "ths", "trl".

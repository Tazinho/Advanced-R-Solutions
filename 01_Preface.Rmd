...
Since this book builds so heavily on Advanced R, we think it should be read together with the textbook, either as a hardcopy or the online version (https://adv-r.hadley.nz). Working on an exercise first by yourself should give you the biggest benefit.

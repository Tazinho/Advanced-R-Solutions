...
contribs_all <- contribs_all %>%
  bind_rows(tibble(login = "emilyriederer"))
...
- The printed version of the book was rendered with R version 4.0.3 (2020-10-10) and the most recent available package versions as of December 2020. (The print version of Advanced R was rendererd with R version 3.5.2.)

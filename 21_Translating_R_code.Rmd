...
We implement the desired change and add the optional argument `script` to the `escape()` and the `tag()` functions (default: `FALSE`). The argument has to be added for all methods of the `escape()` generic.

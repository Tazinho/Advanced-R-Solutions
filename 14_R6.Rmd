...
__[A]{.solved}__: Our new `"ShuffledDeck"` class will use `sample()` and positive integer subsetting to implement the reshuffling and drawing functionality. We also add a check, so you cannot draw more cards then there are left in the deck.
...
__[A]{.solved}__: Because S3 classes obey R's usual semantics of copy-on-modify: every time you deposties from the bank account or drew a card from the deck, you'd get a new copy of the object.

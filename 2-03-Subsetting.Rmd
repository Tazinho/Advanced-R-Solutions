...
## Selecting a single argument

1.  __<span style="color:red">Q</span>__: Come up with as many ways as possible to extract the third value from the `cyl` variable in the `mtcars` dataset.

...
mod$df.residual       # `$` returns a single the element
mod$df.res            # `$` allows partial matching
mod["df.residual"]    # `[` generates list output
mod[["df.residual"]]  # `[[` returns a single element
```

...
6. __[Q]{.Q}__: What are the arguments to `[`? Why is this a hard question to answer?
   ...
   __[A]{.solved}__: The subsetting operator `[` is a primitive and generic function, which can confirmed via `ftype()`.
   ...
   When we inspect the arguments the `[`'s methods, we see that the arguments vary with the class of `x`.

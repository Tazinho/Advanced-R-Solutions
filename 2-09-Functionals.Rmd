...
4. __<span style="color:red">Q</span>__: The following code simulates the performance of a t-test for non-normal data. Extract the p-value from each test, then visualise.
   ...
   __<span style="color:green">A</span>__: There are many ways to visualise this data, but since it's relatively small, a dot plot allows us to see both the individual values and the overall distribution. 

...
2. __<span style="color:red">Q</span>__: What are the arguments to the `for()` and `while()` calls? 
...
3. __<span style="color:red">Q</span>__: Two arithmetic operators can be used in both prefix and infix style.
   What are they?

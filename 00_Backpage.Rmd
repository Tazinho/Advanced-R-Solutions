...
### Malte Grosser
Malte Grosser is a business mathematician from Hamburg who has been programming regularly in R since the beginning of his career. He currently pursues a PhD in machine learning from medical images and develops robust business solutions in R as a consultant. Malte likes to facilitate and engage the local R community and also captured his recommendations for string parsing in R in the {snakecase}-package.

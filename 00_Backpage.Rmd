...
### Paragraph 1/2
This book provides solutions to the exercises contained in the 2nd Edition of Advanced R (Wickham, 2019). Advanced R introduces programmers and R users to various aspects of modern R programming. It also presents many challenging problems to test and expand your knowledge of the R language and important programming paradigms.

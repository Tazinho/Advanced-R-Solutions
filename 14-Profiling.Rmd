...
1.  __<span style="color:red">Q</span>__: The density functions, e.g., `dnorm()`, have a common interface. Which 
    ...
    They are vectorised over their numeric arguments, which is always the first argument (`x`, `a`, `p`, `n`), 'mean' and 'sd'. Note that it's dangerous to supply a vector to `n` in the `rnorm()` function, since the behaviour will change, when `n` has length 1.

...
__[A]{.solved}__: `ifelse()`'s arguments are named `test`, `yes` and `no`. It returns the entry for `yes` when `test` is `TRUE`, `no` when `test` is `FALSE` or `NA` when `test` is `NA`. Therefore, the expressions above return vectors of type `double`, `character` and `logical`.

...
1.  __<span style="color:red">Q</span>__: Fix each of the following common data frame subsetting errors:
    ...
    ```  
<!-- Finde den Pfeil nicht ganz optimal, da er die alte Lösung betont, vielleicht stattdessen "use '==' instead of '=' verwenden? (auch nicht optimal, da umständlich)"     -->
...
<!-- Mir ist gar nicht ovll klar, was hier mit 'NA_real' genau gemeint ist. Ein "echter" NA-Eintrag in 'x'? -->
...
<!-- Hast du hier an alles gedacht? Ist die Antwort vollständig? -->
...
<!-- Ok, den Code zu dem Diagnoalen-Subsetting muss ich mir nochmal ansehen. -->
...
<!-- Warum ist 'drop' wichtig? -->
<!-- Maybe we can do this in a tidyvers-style also! :) [in the Tidyverse-Cookbook]-->
